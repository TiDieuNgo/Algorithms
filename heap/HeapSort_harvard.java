 ...
 */
public class HeapSort_harvard<T extends Comparable<T>> {
    private T[] contents;
    private int numItems;

    public HeapSort_harvard(int maxSize) {
        contents = (T[])new Comparable[maxSize];
        numItems = 0;
    }

    public HeapSort_harvard(T[] arr) {
    ...
    public static void main(String[] args) {
        ...
        HeapSort_harvard<Integer> heap = new HeapSort_harvard<Integer>(maxSize);
